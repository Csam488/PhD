...
while read sample bstat_dir dist cutoff null; do
    ...
    python ${CLASSIFIER_DIR}/filter_sample_clusters.py ${fin} ${outdir}/${sample}_${svtype}.reads ${sample} -c 3 \
    --exclude ${liWGS_SV}/data/b37.lumpy.exclude.4-13.bed > ${outdir}/${svtype}_filter.out
