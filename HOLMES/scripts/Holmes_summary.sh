...
echo -e "STATUS [$(date)]: Reporting Variants Per Sample"
...
+----------------+\n\
 => Deletion Variants [All]\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f2 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f11 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Deletion Variants [HQ]\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f3 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f12 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Tandem Duplication Variants [All]\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f4 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f13 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Tandem Duplication Variants [HQ]\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f5 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f14 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Insertion Variants\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f6 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f15 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Simple Inversion Variants\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f7 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f16 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Translocation Variants\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f8 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f17 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Complex Variants\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f9 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f18 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
 => Incompletely Resolved Sites\n\
      ...
      -Median per sample (w/ artifacts): $( cut -f10 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
      -Median per sample (w/o artifacts): $( cut -f19 ${OUTDIR}/QC/cohort/${COHORT_ID}.SV.metrics | sed -e '1,3d' | sort -nk1,1 | perl -e '$d=.5;@l=<>;print $l[int($d*$#l)]' )\n\
\n\n\
+----------+\n\
| SV SIZES |\n\
+----------+" >> ${OUTDIR}/${COHORT_ID}.run_summary.txt
#Gather matrix of variants in cohort and per sample, then plot
echo -e "STATUS [$(date)]: Plotting"
...
#Gather sizes & plot
echo -e "STATUS [$(date)]: Gathering Sizes"
...
echo -e "STATUS [$(date)]: Gathering Frequencies"
