...
options(scipen=1000)
#paste(thing,thing,sep="thing)"
##Loads required packages; installs if necessary##
if("flexmix" %in% rownames(installed.packages()) == FALSE)
{install.packages("flexmix",repos="http://cran.rstudio.com")}
suppressMessages(library(flexmix))
if("prabclus" %in% rownames(installed.packages()) == FALSE)
{install.packages("prabclus",repos="http://cran.rstudio.com")}
suppressMessages(library(prabclus))
if("diptest" %in% rownames(installed.packages()) == FALSE)
{install.packages("diptest",repos="http://cran.rstudio.com")}
...
if("trimcluster" %in% rownames(installed.packages()) == FALSE)
{install.packages("trimcluster",repos="http://cran.rstudio.com")}
suppressMessages(library(trimcluster))
...
{install.packages(paste(.libPaths()[1],"fpc_2.1-11.2.tar.gz",sep="/"),repos=NULL)}
